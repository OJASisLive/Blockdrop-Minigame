...
public class JoinLeaveHandler {
    public static String joinArena(String arenaName,String playerName){
        ...
        //Done:Add a method to check if the player is added in an arena to avoid adding same player in multiple arenas
        //Done:Add leaveArena method
        //Done:Add a listener if player leaves remove the player from arena's player list
    }
